...
//book name: text,1 to 32 characters
//author: text,1 to 32 characters
//total page count: number,0 to 10,000
//pages read: number,0 to 10,000
//read before: checkbox,yes or no

function formConstraints(input) {
  for (input of inputs) {
      ...
      case "text":
        input.addEventListener("input", () => {
          ...
          if (
            ...
            input.setCustomValidity(
              "Please enter a name between 0 and 32 characters long"
            );
          }
        });
      case "checkbox":
...
// inputs[-1].addEventListener("submit", () => {
//   for (input of inputs.slice(-1)) {
//     if (input.validity.valid) {
//     }
//   }
// });
